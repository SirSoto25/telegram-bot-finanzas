...
def register_handlers(application, handlers):
    ...
    application.add_handler(CommandHandler("comparar", handlers["cmd_comparar"]))
    application.add_handler(CommandHandler("burnrate", handlers["cmd_burnrate"]))
    application.add_handler(CommandHandler("ahorro", handlers["cmd_ahorro"]))
    application.add_handler(CommandHandler("consejo", handlers["cmd_consejo"]))
