...
from commands import (
    ...
    cmd_help, cmd_ingreso, cmd_ingresorecurrente, cmd_menu, cmd_metas,
    cmd_nueva_cuenta, cmd_nuevameta, cmd_panel, cmd_presupuesto,
    cmd_presupuestoset, cmd_recurrente, cmd_redondeo, cmd_redondeo_cuenta,
    cmd_redondeo_toggle, cmd_reset, cmd_start, cmd_stats,
