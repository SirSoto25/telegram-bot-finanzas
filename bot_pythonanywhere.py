...
from commands import (
    ...
    cmd_comparar, cmd_consejo, cmd_cuentas, cmd_deudas, cmd_deshacer, cmd_exportar, cmd_factura, cmd_facturas, cmd_fantasmas, cmd_forecast, cmd_gasto,
    cmd_gasto_rapido, cmd_help, cmd_ingreso, cmd_ingresorecurrente, cmd_logros, cmd_menu, cmd_metas,
    cmd_nueva_cuenta, cmd_nuevameta, cmd_panel, cmd_patrimonio, cmd_presupuesto,
    cmd_presupuestoset, cmd_proyeccion, cmd_racha, cmd_recurrente, cmd_redondeo, cmd_redondeo_cuenta,
    cmd_redondeo_toggle, cmd_regla, cmd_reset, cmd_resumen_anual, cmd_resumendiario, cmd_split, cmd_start, cmd_stats,
...
async def _create_ptb_app():
    ...
    async with _ptb_app_lock:
        ...
        register_handlers(application, {
            ...
            "cmd_racha": cmd_racha,
            "cmd_logros": cmd_logros,
            "cmd_resumen_anual": cmd_resumen_anual,
            "cmd_split": cmd_split,
            "cmd_deudas": cmd_deudas,
